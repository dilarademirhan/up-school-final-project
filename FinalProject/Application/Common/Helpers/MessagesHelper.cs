...
public static class MessagesHelper
{
    public static class Email
    {
        ...
        {
            public static string Subject => "Thank you for signing up to CrawlerApp!";
            public static string ActivationMessage => "Thank you for signing up to CrawlerApp! " +
                "In order to activate your account please click the activation button given below.";
