...
namespace FinalProject.WebApi.Controllers
{
    ...
    public class GoogleLoginController : ControllerBase
    {
        ...
        private const string REDIRECT_URI = "https://localhost:7296/api/GoogleLogin/GoogleSignIn";
        private readonly IAuthenticationService _authenticationService;

        public GoogleLoginController(IOptions<GoogleSettings> googleSettings, IAuthenticationService authenticationService)
        {
